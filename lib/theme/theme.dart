...
const Color secondaryColor = Color.fromARGB(255, 109, 109, 109);*/
/*
const Color primaryColor = Color.fromARGB(255, 119, 203, 255);
const Color secondaryColor = Color.fromARGB(255, 8, 6, 88);
*/
const Color primaryColor = Color.fromARGB(255, 100, 170, 93);
const Color secondaryColor = Color.fromARGB(255, 34, 70, 10);
